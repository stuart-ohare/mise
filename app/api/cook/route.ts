...
export async function POST(request: Request): Promise<Response> {
  ...
  // Parsed on the way out too: a pipeline that returned a shape the screen can't render
  // should fail here, where it is one stack trace, not there, where it is a blank page.
